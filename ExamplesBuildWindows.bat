@echo off
mkdir bin
copy "mod.io-sdk-v0.12.12\bin\nmake\x86\modio.dll" bin
cl /D_USRDLL /D_WINDLL ./src/modioWrapper.cpp ./src/modioWrapperCallbacks.cpp ./src/modioWrapperObjects.cpp mod.io-sdk-v0.12.12/lib/nmake/x86/modio.lib /I include /I mod.io-sdk-v0.12.12/include /link /DLL /OUT:bin/modioWrapperWindows_x86.ndll
...
haxe -cp src/examples -main Ex08_GetUserSubscriptions -cpp bin -D windows
haxe -cp src/examples -main Ex09_SetEventListener -cpp bin -D windows