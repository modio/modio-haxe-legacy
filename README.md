...
Before starting, make sure you have installed [Haxe](https://haxe.org/download/). Once you finished installed Haxe, install `haxelib` by typing `haxelib install hxcpp` on your terminal.
